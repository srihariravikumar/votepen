    ...
    export default {
        ...
        computed: {
            compiled(){
                ...
                text = text.replace(/(?:^| )(@[A-Za-z0-9\._]+)/gm, " [$1](https://votepen.com/$1)");
                text = text.replace(/(?:^| )#([A-Za-z0-9_]+)/gm, " [#$1](https://votepen.com/c/$1)");
                text = text.replace(/(?:^| )\/c\/([A-Za-z0-9_]+)/gm, " [#$1](https://votepen.com/c/$1)");
                ...
                text = text.replace(/\[([^\[\n]*)\]\(((https?):\/\/votepen.com\/[^\)]*)\)/igm, "<a href='$2'>$1</a>");
